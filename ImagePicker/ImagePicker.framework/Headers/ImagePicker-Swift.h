...
SWIFT_CLASS("_TtC11ImagePicker10Appearance")
...
SWIFT_CLASS("_TtC11ImagePicker24CameraCollectionViewCell")
...
/// an flip animation.
/// \param completion A block is called as soon as camera is changed.
///
...
/// <ol>
///   <li>
///     action item - register a cell for all items or a different cell for each index.
///   </li>
///   <li>
///     camera item - register a subclass of <code>CameraCollectionViewCell</code> to provide a
///   </li>
///   <li>
///     asset item - each asset media type (image, video) can have it’s own cell
///     custom camera cell implementation.
///   </li>
/// </ol>
SWIFT_CLASS("_TtC11ImagePicker15CellRegistrator")
...
@interface ImagePickerController (SWIFT_EXTENSION(ImagePicker)) <PHPhotoLibraryChangeObserver>
